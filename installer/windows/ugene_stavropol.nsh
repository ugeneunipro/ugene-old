...
Section "Build"
    ...
    !insertmacro AddPlugin BrowserSupport
    ...
    WriteRegStr HKEY_LOCAL_MACHINE "Software\Google\Chrome\Extensions\${CRXID}" "path" "$INSTDIR\${CRXNAME}"
    WriteRegStr HKEY_LOCAL_MACHINE "Software\Google\Chrome\Extensions\${CRXID}" "version"     "${PRODUCT_VERSION}"
    WriteRegStr HKEY_LOCAL_MACHINE "Software\Wow6432Node\Google\Chrome\Extensions\${CRXID}" "path" "$INSTDIR\${CRXNAME}"
    WriteRegStr HKEY_LOCAL_MACHINE "Software\Wow6432Node\Google\Chrome\Extensions\${CRXID}" "version" "${PRODUCT_VERSION}"

    SetOutPath $INSTDIR\Stavropol
    File /r "C:\Stavropol\Stavropol\"
