...
bool BreakpointEqualHitCounter::hit() {
    return (targetHitCount == ++hitCount);
}

quint32 BreakpointEqualHitCounter::getHitCountParameter() const {
    return targetHitCount;
}

void BreakpointEqualHitCounter::setHitCountParameter(quint32 newParameter) {
