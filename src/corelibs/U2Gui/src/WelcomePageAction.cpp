...
#include "WelcomePageAction.h"

namespace U2 {

const QString BaseWelcomePageActions::LOAD_DATA = "load_data";
const QString BaseWelcomePageActions::CREATE_SEQUENCE = "create_sequence";
