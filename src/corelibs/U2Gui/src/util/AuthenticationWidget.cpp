...
void AuthenticationWidget::setRemembered(bool isChecked) {
    cbRemember->setChecked(isChecked);
}

QString AuthenticationWidget::getLogin() const {
    return leLogin->text();
}

QString AuthenticationWidget::getPassword() const {
    return lePassword->text();
}

bool AuthenticationWidget::isRemembered() const {
