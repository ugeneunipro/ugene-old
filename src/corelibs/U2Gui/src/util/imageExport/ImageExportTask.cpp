...
const QString ImageExportTask::WRONG_FORMAT_MESSAGE = tr("Format %1 is not supported by %2");
const QString ImageExportTask::EXPORT_FAIL_MESSAGE = tr("Failed to export image to %1");
