...
const QString CircularViewSettingsWidgetFactory::GROUP_TITLE = QString(tr("Circular View Settings"));
...
QWidget* CircularViewSettingsWidgetFactory::createWidget(GObjectView *objView) {
    ...
    connect(ctx, SIGNAL(si_cvSplitterWasCreatedOrRemoved(CircularViewSplitter*)),
            widget, SLOT(sl_cvSplitterWasCreatedOrRemoved(CircularViewSplitter*)));
