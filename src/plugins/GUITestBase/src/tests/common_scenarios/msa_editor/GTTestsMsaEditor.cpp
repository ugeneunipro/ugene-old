...
//    press OK
    ...
    CHECK_SET_ERR(bigSize==5131678 && smallSize==1012635, QString().setNum(bigSize) + "  " + QString().setNum(smallSize));
//    Expected state: image is exported
}
...
//    press OK
    ...
    CHECK_SET_ERR(bigSize > 800000 && bigSize < 1350000  && smallSize > 165000 && smallSize < 265000, QString().setNum(bigSize) + "  " + QString().setNum(smallSize));
//    Expected state: image is exported
}
...
//    press Save
    ...
    CHECK_SET_ERR(fileSize==674882, "Expected size: 674882, Current size: " + QString().setNum(fileSize));
