...
//    press OK
    ...
    CHECK_SET_ERR(bigSize==550434 && smallSize==110888, QString().setNum(bigSize) + "  " + QString().setNum(smallSize));
//    Expected state: image is exported
}
...
//    press Save
    qint64 fileSize = GTFileDialog::getSize(os,testDir + "_common_data/scenarios/sandbox/", "test.svg");
    CHECK_SET_ERR(fileSize==555706, "Current size: " + QString().setNum(fileSize));
//    Expected state:  SVG is exported
