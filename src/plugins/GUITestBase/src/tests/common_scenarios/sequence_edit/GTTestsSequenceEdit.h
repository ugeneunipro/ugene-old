...
GUI_TEST_CLASS_DECLARATION(test_0013_1_neg)
GUI_TEST_CLASS_DECLARATION(test_0013_2)
GUI_TEST_CLASS_DECLARATION(test_0013_2_neg)
GUI_TEST_CLASS_DECLARATION(test_0014_1)
GUI_TEST_CLASS_DECLARATION(test_0014_1_neg)
GUI_TEST_CLASS_DECLARATION(test_0014_2)
GUI_TEST_CLASS_DECLARATION(test_0014_2_neg)
GUI_TEST_CLASS_DECLARATION(test_0015_1)
GUI_TEST_CLASS_DECLARATION(test_0015_1_neg)
GUI_TEST_CLASS_DECLARATION(test_0015_2)
GUI_TEST_CLASS_DECLARATION(test_0015_2_neg)
