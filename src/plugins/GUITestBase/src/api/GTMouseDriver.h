...
public:
    ...
    static void click(U2OpStatus &os, Qt::MouseButton = Qt::LeftButton); //all click methods click the current position of the cursor
    static void press(U2OpStatus &os, Qt::MouseButton button);
    static void release(U2OpStatus &os, Qt::MouseButton button); //release method should check if this key has been already pressed. Do nothing otherwise
