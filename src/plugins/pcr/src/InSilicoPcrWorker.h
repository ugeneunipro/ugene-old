...
private:
    ...
    QVariant createProductSequence(const InSilicoPcrTaskSettings &settings, const InSilicoPcrProduct &product, U2OpStatus &os);
    QVariant createPrimerAnnotations(const InSilicoPcrProduct &product);
