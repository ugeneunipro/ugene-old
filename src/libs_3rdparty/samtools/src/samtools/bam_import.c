...
#define true 1
#define false 0
static inline bool append_text(bam_header_t *header, kstring_t *str)
{
...
#define PARSE_ERROR(n_lines, msg)  \
{ \
    parse_error(n_lines, msg); \
