...
//}
	...
	void TriangulatedSAS::compute(int& progress)
		throw()
	{
...
//////////////////////////////////////////////////
	...
	void SASTriangulator::run(int& progress)
		throw()
	{
		...
		uint numFaces = tsas_->sas_->number_of_faces_;
        for (Position i = 0; i < numFaces; i++)
		{
			triangulateFace(tsas_->sas_->faces_[i]);
            progress = (i + 1) * 100 / numFaces;
		}
	}
