	...
	*/
	namespace Constants 
	{
		...
		*/
		...
		/// PI
		BALL_EXPORT extern const double  PI;

		/// Euler's number - base of the natural logarithm
		BALL_EXPORT extern const double  E;

		/**	Internal theshold for equality comparisons.
				Default value is 1e-6.
		*/
		BALL_EXPORT extern double EPSILON;
		//@}
		...
		*/
		BALL_EXPORT extern const double	ELEMENTARY_CHARGE;  	 // C     
	
		/// Elementary charge (alias)
		BALL_EXPORT extern const double	e0;

		/** Electron mass.
				In units of kg (\f$9.1093897 \cdot 10^{-31}\f$ kg).
		*/
		BALL_EXPORT extern const double	ELECTRON_MASS   	;   	 // kg

		/** Proton mass.
				In units of kg (\f$1.6726230 \cdot 10^{-27}\f$ kg).
		*/
		BALL_EXPORT extern const double	PROTON_MASS     	;   	 // kg

		/** Neutron mass.
				In units of kg (\f$1.6749286 \cdot 10^{-27}\f$ kg).
		*/
		BALL_EXPORT extern const double	NEUTRON_MASS    	;   	 // kg

		/** Avogadro constant.
				In units of \f$mol^{-1}\f$ (\f$6.0221367 \cdot 10^{23} mol^{-1}\f$).
		*/
		BALL_EXPORT extern const double	AVOGADRO;

		/** Avogadro constant (alias)
		*/
		BALL_EXPORT extern const double	NA;

		/** Avogadro constant (alias)
		*/
		BALL_EXPORT extern const double	MOL;

		/** Boltzmann constant.
				In units of J/K (\f$1.380657 \cdot 10^{-23}\f$ J/K).
		*/
		BALL_EXPORT extern const double	BOLTZMANN;

		/** Boltzmann constant (alias)
		*/
		BALL_EXPORT extern const double	k;
		
		/** Planck constant.
				In units of Js (\f$6.6260754 \cdot 10^{-34}\f$ Js).
		*/
		BALL_EXPORT extern const double	PLANCK;

		/** Planck constant (alias)
		*/
		BALL_EXPORT extern const double	h;

		/** Gas constant (= NA * k)	
		*/
		BALL_EXPORT extern const double	GAS_CONSTANT;

		/** Gas constant (alias)
		*/
		BALL_EXPORT extern const double R;

		/** Faraday constant (= NA * e0)
		*/
		BALL_EXPORT extern const double	FARADAY;

		/** Faraday constant (alias)
		*/
		BALL_EXPORT extern const double	F;

		/** Bohr radius.
				In units m (\f$5.29177249 \cdot 10^{-11}\f$ m).
		*/
		BALL_EXPORT extern const double	BOHR_RADIUS;

		/** Bohr radius (alias)
		*/
		BALL_EXPORT extern const double	a0;
		...
		*/
		BALL_EXPORT extern const double	VACUUM_PERMITTIVITY;

		/** Vacuum permeability.
				In units of \f$Js^2C^{-2}m^{-1}\f$ (\f$4\pi \cdot 10^{-7} Js^2C^{-2}m^{-1}\f$).
		*/
		BALL_EXPORT extern const double	VACUUM_PERMEABILITY;

		/** Speed of light.
				In units of m/s (\f$2.99792458 \cdot 10^8 ms^{-1}\f$).
		*/
		BALL_EXPORT extern const double	SPEED_OF_LIGHT;

		/** Speed of Light (alias)
		*/
		BALL_EXPORT extern const double	c;

		/** Gravitational constant.
				In units of \f$Nm^2kg^{-2}\f$ (\f$6.67259 \cdot 10^{-11} Nm^2kg^{-2}\f$).
		*/
		BALL_EXPORT extern const double	GRAVITATIONAL_CONSTANT;

		/** Fine structure constant.
				Without unit (\f$7.29735 \cdot 10^{-3}\f$).
		*/
		BALL_EXPORT extern const double	FINE_STRUCTURE_CONSTANT;
		//@}
		...
		*/
		...
		/** Degree per rad.
				57.2957795130823209
		*/
		BALL_EXPORT extern const double	DEG_PER_RAD;

		/** Rad per degree.
				0.0174532925199432957
		*/
		BALL_EXPORT extern const double	RAD_PER_DEG;

		/** mm per inch.
				25.4
		*/
		BALL_EXPORT extern const double	MM_PER_INCH 			;

		/** m per foot.
				3.048
		*/
		BALL_EXPORT extern const double	M_PER_FOOT  			;

		/** Joules per calorie.
				4.184
		*/
		BALL_EXPORT extern const double	JOULE_PER_CAL;

		/** Calories per Joule.
				1/JOULE_PER_CAL
		*/
		BALL_EXPORT extern const double	CAL_PER_JOULE;
