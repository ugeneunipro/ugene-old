...
void increase_gaps(float* prof,int len,int window,float strength)
{
	...
	//only gpo first....
	for ( i = 0; i < len;i++){
// 	//	k_printf("(%0.2f:%0.2f) ",prof[26],prof[23]);
		prof[26] = 0.0;
		prof+= 64;
	}
	prof -= len << 6;
