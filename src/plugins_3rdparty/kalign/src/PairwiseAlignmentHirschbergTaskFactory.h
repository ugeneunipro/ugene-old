...
#ifndef _U2_PAIRWISE_ALIGNMENT_HIRSCHBERG_TASK_FACTORY_H_
#define _U2_PAIRWISE_ALIGNMENT_HIRSCHBERG_TASK_FACTORY_H_
...
#endif // _U2_PAIRWISE_ALIGNMENT_HIRSCHBERG_TASK_FACTORY_H_
