...
const unsigned K = MuscleContext::finddiagsn_struct::K;
const unsigned KTUPS = MuscleContext::finddiagsn_struct::KTUPS;


/*static char *TupleToStr(int t)
	{
    char *g_LetterToChar = getMuscleContext()->alpha.g_LetterToChar;
	static char s[K];
